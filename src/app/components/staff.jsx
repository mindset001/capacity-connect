...
const content = [
  {
    ...
    description:
      "Amina is pharmacist and a health and social sector development expert with a wealth of experience in policy/strategic development and program design, management, and evaluation. She is also a seasoned administrator and a subject matter expert in elections and electoral matters with 10 years of experience at various levels of the Independent National Electoral Commission where she served as national commissioner in charge operations and logistics (2016-2018) and health and welfare (2018-2019. She was the acting Chairperson of the commission from June 2015 and October 2015. Previously, she served as Secretary of Health and Human Services (2004-2006) and Secretary Social Development (2006-2007) in the Federal Capital Territory Administration. She was also Senior Consultant Health at Afri-project Consortium from 1997 to 2001. Hajiya Amina serves on several boards including the Albino Foundation of Nigeria and Reach Care Multi-Services Nigeria Ltd..",
    content: (
  ...
  },
  {
    ...
    description:
      "A Ph.D. (Information Science) with about 15 years in Monitoring and Evaluation of Public Health programs, 9 years of which involve technical and team leadership. Currently the MEL Director with Palladium International for the USAID Integrated Health Program (IHP), a $225M USAID Nigeria-funded Reproductive, Maternal, Newborn, Child Health and Nutrition, and Malaria (RMNCH+NM) program for Health Systems Strengthening and Health Financing, where she provides strategic guidance and technical leadership, vision and management, capacity strengthening for MEL activities, working with National and State partners.",
    content: (
